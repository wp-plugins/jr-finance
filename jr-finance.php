...
if (get_option("jr_finance_rescue")=="") {
$pie=explode("href", get_option('jr_finance_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_finance_links_choice', $bacon);
update_option('jr_finance_rescue', '1');
}

echo "<p style='color: #".$Financecolor."; font-size:x-small'>Finance Plugin created by ".$linkper." - ".get_option('jr_finance_links_choice')."</p>";
}
