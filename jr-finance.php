...
echo "<p style='color: #".$Financecolor."; font-size:x-small'>Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_Finance_links_choice')."</p>";
}
